...
export const InputCheckModule = ({
  ...
  const [isEmailValid, setEmailValid] = useState(EmailInputValidation(email));
  const [PasswordValidation, setPasswordValidation] = useState(
    PasswordInputValidation(password)
  );
  const [isFullPasswrodValid, setIsFullPasswordValid] = useState(
    PasswordValidation.isPasswordMinLength &&
  ...
  useEffect(() => {
    setPasswordValidation(PasswordInputValidation(password));
  }, [password]);
